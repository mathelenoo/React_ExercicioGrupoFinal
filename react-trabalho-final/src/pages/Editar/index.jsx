...
const validationPost = yup.object().shape({
    ...
    categoria: yup
        ...
        .typeError("Valores permitidos: 1 para Ficção Cientifica, 2 para Fantasia, 3 para Romance, 4 para Literatura Classica, 5 para Suspense, 6 para Horror, 7 para Poesia, 8 para Historia, 9 para Biografia, 10 para Autobiografia")
                ...
                <div className="cards">
                    <form onSubmit={handleSubmit(addPost)}>
                        <div className="card">
                            ...
                            <input type="text" id="numeroPaginas" {...register("numeroPaginas")} />
